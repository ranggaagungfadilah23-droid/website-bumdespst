...
<div class="p-4 space-y-5">
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        <div class="bg-white border border-slate-100 p-4 rounded-xl shadow-sm col-span-2">
            ...
            <p class="text-slate-400 text-[10px] font-bold uppercase tracking-wide">Pendapatan Jasa</p>
    ...
    <div class="bg-white p-4 rounded-xl border border-slate-100 shadow-sm">
        <h3 class="font-bold text-slate-700 text-sm mb-1">Tren Pendapatan Jasa</h3>
    ...
    <div class="bg-white p-4 rounded-xl border border-slate-100 shadow-sm">
        <h3 class="font-bold text-slate-700 text-sm mb-1">Status Pesanan Jasa</h3>
            ...
            <table class="w-full text-xs text-left min-w-[500px]">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-4 py-3 text-slate-500">{{ $item->jasa->nama_jasa ?? '-' }}</td>
                        <td class="px-4 py-3">
