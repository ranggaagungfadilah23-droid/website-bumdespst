...
<div class="p-4 md:p-6 space-y-6">
    ...
    <div>
        ...
        <p class="text-slate-400 text-xs md:text-sm mt-1">
            {{ now()->translatedFormat('l, d F Y') }} — Dashboard Jasa {{ Auth::user()->mitra->nama_usaha ?? '' }}.
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-5">
        ...
        <div class="bg-white border border-slate-100 p-5 md:p-6 rounded-2xl shadow-sm">
            <div class="flex items-center justify-between mb-4">
                <p class="text-slate-400 text-xs font-bold uppercase tracking-wider">Pendapatan Jasa</p>
        ...
        <div class="bg-white border border-slate-100 p-5 md:p-6 rounded-2xl shadow-sm">
            <div class="flex items-center justify-between mb-4">
                <p class="text-slate-400 text-xs font-bold uppercase tracking-wider">Selesai</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div class="bg-white p-5 md:p-6 rounded-2xl border border-slate-100 shadow-sm">
            <h3 class="font-bold text-slate-700 mb-1">Tren Pendapatan Jasa</h3>
        ...
        <div class="bg-white p-5 md:p-6 rounded-2xl border border-slate-100 shadow-sm">
            <h3 class="font-bold text-slate-700 mb-1">Status Pesanan Jasa</h3>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        {{-- overflow-x-auto supaya tabel tetap enak dibaca di layar kecil --}}
